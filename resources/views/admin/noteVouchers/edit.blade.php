                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control product-unit" name="products[{{ $key }}][unit]">
                                    ...
                                    @foreach ($voucherProduct->units as $unit)
                                        <option value="{{ $unit->id }}" {{ $voucherProduct->pivot->unit_id == $unit->id ? 'selected' : '' }}>{{ $unit->name_ar }}</option>
                                    @endforeach
                                    @if ($voucherProduct->unit)
                                        <option value="{{ $voucherProduct->unit->id }}" {{ $voucherProduct->pivot->unit_id == $voucherProduct->unit->id ? 'selected' : '' }}>{{ $voucherProduct->unit->name_ar }}</option>
                                    @endif
                                </select>
                            </td>
