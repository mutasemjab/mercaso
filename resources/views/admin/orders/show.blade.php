    ...
    <div class="bill-ship">
        ...
        <div>
            ...
            @if($order->address)
                ...
                <p>{{ $order->address->building_number ?? '' }}</p>
            @else
                <p>N/A</p>
            @endif
        </div>
    ...
    <table class="products-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="numeric">${{ number_format($product->pivot->total_price_before_tax / $product->pivot->quantity, 2) }}</td>
                <td class="numeric">${{ number_format($product->pivot->total_price_after_tax, 2) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
