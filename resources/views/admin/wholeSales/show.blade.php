...
@section('title')
    {{ __('messages.Show') }} {{ __('messages.wholeSales') }}
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center"> {{ __('messages.Show') }} {{ __('messages.wholeSales') }} </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
               ...
               <div class="image">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <h6>@if($data['user_type'] == 1) User @else Whole Sale @endif</h6>
                    </div>
                </div>
