...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center"> {{ __('messages.Add_New') }} {{ __('messages.cities') }} </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group text-center">
                            ...
                            <a href="{{ route('cities.index') }}" class="btn btn-sm btn-danger">{{__('messages.Cancel')}}</a>
