...
<head>
    ...
    <meta name="description" content="Privacy Policy for {{ config('app.name') }}. Learn how we collect, use, and protect your personal information.">
    <meta name="robots" content="index, follow">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="{{ $page->title ?? 'Privacy Policy' }}">
    <meta property="og:description" content="Privacy Policy for {{ config('app.name') }}">
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="{{ $page->title ?? 'Privacy Policy' }}">
    <meta name="twitter:description" content="Privacy Policy for {{ config('app.name') }}">
    ...
    <main class="main-container">
        <article class="page-container">
            ...
            <header class="page-header">
                <h1 class="page-title">{{ $page->title ?? 'Privacy Policy' }}</h1>
            ...
            <footer class="page-actions">
                <div class="action-buttons">
                    ...
                    <a href="{{ route('terms.conditions') }}" class="btn btn-secondary">
