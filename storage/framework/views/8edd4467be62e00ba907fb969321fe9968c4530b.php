                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($info->productImages->isNotEmpty()): ?>
                                            <div class="image">
                                                <img class="custom_img" src="<?php echo e(asset('assets/admin/uploads/' . $info->productImages->first()->photo)); ?>" alt="Product Image">
                                            </div>
                                        <?php else: ?>
                                            No Photo
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u573862697/domains/vertex-jordan.online/public_html/resources/views/admin/products/index.blade.php ENDPATH**/ ?>