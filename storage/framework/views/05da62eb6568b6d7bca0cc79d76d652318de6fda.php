...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="pin" id="pin" class="form-control" value="<?php echo e(old('pin', $data['pin'])); ?>" maxlength="6" placeholder="Enter 6-digit PIN">
                            <?php $__errorArgs = ['pin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="activate" id="activate" class="form-control">
                                ...
                                <option <?php if($data->activate == 1): ?> selected="selected" <?php endif; ?> value="1">activate
                                </option>
                                <option <?php if($data->activate == 2): ?> selected="selected" <?php endif; ?> value="2">
                                    Inactivate</option>
                            </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/mercaso/resources/views/admin/customers/edit.blade.php ENDPATH**/ ?>