...
<div class="container-fluid py-4">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body text-center py-4">
                    <h1 class="display-4 font-weight-bold text-primary mb-2">
                        <i class="fas fa-user mr-2"></i><?php echo e(__('messages.customer_report')); ?>

                    </h1>
                    <p class="lead text-muted"><?php echo e(__('messages.search_customer_details')); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-gradient-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-search mr-2"></i><?php echo e(__('messages.search_customer')); ?></h5>
                </div>
                <div class="card-body">
                    <div class="form-group mb-0">
                        <label for="customerSearch" class="font-weight-bold mb-2">
                            <?php echo e(__('messages.customer_name_email_phone')); ?>:
                        </label>
                        <div class="input-group input-group-lg">
                            <input type="text"
                                   id="customerSearch"
                                   class="form-control"
                                   placeholder="<?php echo e(__('messages.type_customer_name_email_phone')); ?>"
                                   autocomplete="off">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="button" id="applyBtn" disabled>
                                    <i class="fas fa-check mr-2"></i><?php echo e(__('messages.Apply')); ?>

                                </button>
                                <button class="btn btn-outline-secondary" type="button" id="resetBtn">
                                    <i class="fas fa-redo mr-2"></i><?php echo e(__('messages.Reset')); ?>
    ...
    <div id="loadingSpinner" style="display: none;" class="text-center py-5">
        ...
        <p class="text-muted mt-2"><?php echo e(__('messages.Loading')); ?>...</p>
    </div>
    ...
    <div id="resultsSection" style="display: none;">
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2"><strong><?php echo e(__('messages.Email')); ?>:</strong> <span id="customerEmail"></span></p>
                                <p class="mb-2"><strong><?php echo e(__('messages.Phone')); ?>:</strong> <span id="customerPhone"></span></p>
                                <p class="mb-0"><strong><?php echo e(__('messages.Location')); ?>:</strong> <span id="customerLocation"></span></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-2"><strong><?php echo e(__('messages.Member_Since')); ?>:</strong> <span id="customerJoinDate"></span></p>
                                <p class="mb-0"><strong><?php echo e(__('messages.last_order_date')); ?>:</strong> <span id="customerLastOrder"></span></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-left-primary shadow-sm h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?>">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    <?php echo e(__('messages.total_orders')); ?>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?>">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    <?php echo e(__('messages.average_order_value')); ?>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?>">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    <?php echo e(__('messages.total_discount')); ?>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-gradient-dark text-white">
                        <h5 class="mb-0"><i class="fas fa-list mr-2"></i><?php echo e(__('messages.purchase_history')); ?></h5>
                    </div>
                            ...
                            <table class="table table-bordered table-striped mb-0 table-hover">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-right"><?php echo e(__('messages.total_price')); ?></th>
                                        <th class="text-right"><?php echo e(__('messages.total_discount')); ?></th>
                                        <th class="text-right"><?php echo e(__('messages.tax_value')); ?></th>
                                        <th class="text-right"><?php echo e(__('messages.delivery_fee')); ?></th>
                                        <th class="text-center"><?php echo e(__('messages.payment_status')); ?></th>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-gradient-dark text-white">
                        <h5 class="mb-0"><i class="fas fa-box mr-2"></i><?php echo e(__('messages.purchased_products')); ?></h5>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped mb-0 table-hover">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo e(__('messages.Quantity')); ?></th>
                                        <th class="text-right"><?php echo e(__('messages.total_price')); ?></th>
                                    </tr>
                                </thead>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        fetch('<?php echo e(route("customer-report.search")); ?>?search=' + encodeURIComponent(searchTerm))
    ...
    function displayCustomerStats(data) {
        ...
        const ordersShowBaseUrl = `<?php echo e(url('/en/admin/orders')); ?>`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/mercaso/resources/views/reports/customer-report.blade.php ENDPATH**/ ?>