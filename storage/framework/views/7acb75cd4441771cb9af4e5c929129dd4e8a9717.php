        ...
        <div class="col-md-12">
            ...
            <form method="GET" action="<?php echo e(route('order_report')); ?>">
                <div class="form-row align-items-end">
                    ...
                    <div class="form-group col-md-3">
                        <label for="representative_id"><?php echo e(__('messages.representatives')); ?></label>
                        <select id="representative_id" name="representative_id" class="form-control">
                            ...
                            <?php $__currentLoopData = $representatives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $representative): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($representative->id); ?>" <?php echo e(request('representative_id') == $representative->id ? 'selected' : ''); ?>><?php echo e($representative->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('messages.representative')); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($data['representative']); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u573862697/domains/vertex-jordan.online/public_html/resources/views/reports/order_report.blade.php ENDPATH**/ ?>