    ...
    <form action="<?php echo e(route('orders.store')); ?>" method="POST">
        ...
        <div class="col-md-6">
            <div class="form-group mt-3">
                <label for="order_type"><?php echo e(__('messages.order_type')); ?></label>
                <select name="order_type" class="form-control" required>
                    <option value="">select</option>
                    <option value="1"><?php echo e(__('messages.Sell')); ?></option>
                    <option value="2"><?php echo e(__('messages.Refund')); ?></option>
                </select>
            </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div class="form-group mt-3">
                ...
                <input type="text" id="userSearch" class="form-control" name="user" placeholder="<?php echo e(__('messages.search_customer')); ?>" required />
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function fetchDeliveryFee(deliveryId) {
            fetch(`<?php echo e(url('delivery')); ?>/${deliveryId}/fee`)
                .then(response => response.json())
                .then(data => {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u573862697/domains/vertex-jordan.online/public_html/resources/views/admin/orders/create.blade.php ENDPATH**/ ?>