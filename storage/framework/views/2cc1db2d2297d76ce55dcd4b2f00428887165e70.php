...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="description_fr" id="description_fr" class="form-control" value="<?php echo e(old('description_fr')); ?>" rows="8"></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label> <?php echo e(__('messages.color')); ?></label>
                            <input type="color" name="color" id="color" class="form-control" value="<?php echo e(old('color')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label> <?php echo e(__('messages.color_picker')); ?></label>
                            <input type="color" name="color_picker" id="color_picker" class="form-control" value="<?php echo e(old('color_picker')); ?>">
                            <?php $__errorArgs = ['color_picker'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u573862697/domains/vertex-jordan.online/public_html/resources/views/admin/categories/create.blade.php ENDPATH**/ ?>