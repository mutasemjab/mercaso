        ...
        <div id="ajax_responce_serarchDiv" class="col-md-12">
            ...
            <table id="example2" class="table table-bordered table-hover">
                <thead class="custom_thead">
                    ...
                    <th><?php echo e(__('messages.with_each_other')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($info->with_each_other == 1 ? 'yes' : 'No'); ?></td>
                        <td><?php echo e($info->category->name_en); ?></td>
                        ...
                        <td>
                            ...
                            <a href="<?php echo e(route('banners.edit', $info->id)); ?>" class="btn btn-sm  btn-primary"><?php echo e(__('messages.Edit')); ?></a>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mercaso\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>