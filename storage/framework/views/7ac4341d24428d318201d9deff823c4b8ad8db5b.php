        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <?php if(auth()->user()->is_super_admin == true): ?>
                    ...
                    <?php endif; ?>
                    <?php if($user->can('city-table') || $user->can('city-add') || $user->can('city-edit') || $user->can('city-delete')): ?>
                        <li class="nav-item">
                ...
                <?php else: ?>
                    ...
                    <?php if(
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('representatives.index')); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('product_move_all')); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> <?php echo e(__('messages.product_move_all')); ?> </p>
                                </a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\vertex\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>