...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('coupons.create')); ?>" class="btn btn-sm btn-success"> <?php echo e(__('messages.New')); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupon-edit')): ?>
                                                <a href="<?php echo e(route('coupons.edit', $info->id)); ?>"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupon-delete')): ?>
                                            <form action="<?php echo e(route('coupons.destroy', $info->id)); ?>" method="POST" style="display:inline-block;">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mercaso\resources\views/admin/coupons/index.blade.php ENDPATH**/ ?>