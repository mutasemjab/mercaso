    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- SMS Notifications -->
                <?php if(auth()->user()->can('sms-notification-table')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('sms.create')); ?>" class="nav-link <?php echo e(request()->routeIs('sms.*') ? 'active' : ''); ?>">
                            <i class="nav-icon fas fa-sms"></i>
                            <p><?php echo e(__('messages.sms_notifications')); ?></p>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <!-- Reports -->
                <?php if(auth()->user()->can('order-report') || auth()->user()->can('products-report') || auth()->user()->can('users-report') || auth()->user()->can('category-report-view') || auth()->user()->can('customer-report-view') || auth()->user()->is_super_admin): ?>
                    <li class="nav-item has-treeview <?php echo e(request()->routeIs('*_report') || request()->routeIs('category-report.*') || request()->routeIs('customer-report.*') ? 'menu-open' : ''); ?>">
                        <a href="#" class="nav-link <?php echo e(request()->routeIs('*_report') || request()->routeIs('category-report.*') || request()->routeIs('customer-report.*') ? 'active' : ''); ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if(auth()->user()->can('category-report-view') || auth()->user()->is_super_admin): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('category-report.index')); ?>" class="nav-link <?php echo e(request()->routeIs('category-report.*') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo e(__('messages.category_reports')); ?></p>
                                    </a>
                                </li>
                            <?php endif; ?>

                            <?php if(auth()->user()->can('customer-report-view') || auth()->user()->is_super_admin): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('customer-report.index')); ?>" class="nav-link <?php echo e(request()->routeIs('customer-report.*') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo e(__('messages.customer_reports')); ?></p>
                                    </a>
                                </li>
                            <?php endif; ?>
                        </ul>
...
</aside><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/mercaso/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>