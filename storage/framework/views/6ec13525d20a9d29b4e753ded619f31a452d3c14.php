    ...
    <div class="row">
        <div class="col-12">
            <div class="page-header">
                <h1 class="page-title"><?php echo e(__('Tax & CRV Reports')); ?></h1>
                <p class="page-subtitle"><?php echo e(__('US Government Compliance Reports for Sales Tax and California Redemption Value')); ?></p>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0" id="nextDueDate"><?php echo e(date('M d, Y', strtotime('next month'))); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="card-title mb-0">
                        ...
                        <?php echo e(__('Sales Tax Reports')); ?>
                    ...
                    <form id="taxReportForm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="tax_start_date"><?php echo e(__('Start Date')); ?></label>
                                    <input type="date" class="form-control" id="tax_start_date" name="start_date" value="<?php echo e(date('Y-m-01')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="tax_end_date"><?php echo e(__('End Date')); ?></label>
                                    <input type="date" class="form-control" id="tax_end_date" name="end_date" value="<?php echo e(date('Y-m-t')); ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg" data-format="excel">
                                ...
                                <?php echo e(__('Download Sales Tax Report (Excel)')); ?>

                            </button>
                            <button type="submit" class="btn btn-outline-primary" data-format="json">
                                <i class="fas fa-eye me-2"></i>
                                <?php echo e(__('View Tax Summary')); ?>
                ...
                <div class="card-body">
                    <form id="crvReportForm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="crv_start_date"><?php echo e(__('Start Date')); ?></label>
                                    <input type="date" class="form-control" id="crv_start_date" name="start_date" value="<?php echo e(date('Y-m-01')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="crv_end_date"><?php echo e(__('End Date')); ?></label>
                                    <input type="date" class="form-control" id="crv_end_date" name="end_date" value="<?php echo e(date('Y-m-t')); ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success btn-lg" data-format="excel">
                                <i class="fas fa-download me-2"></i>
                                <?php echo e(__('Download CRV Report (Excel)')); ?>

                            </button>
                            <button type="submit" class="btn btn-outline-success" data-format="json">
                                <i class="fas fa-eye me-2"></i>
                                <?php echo e(__('View CRV Summary')); ?>
            ...
            <div class="card">
                <div class="card-header bg-warning text-dark">
                    <h4 class="card-title mb-0">
                        ...
                        <?php echo e(__('Combined Tax & CRV Report')); ?>

                    </h4>
                </div>
                <div class="card-body">
                    <p class="text-muted"><?php echo e(__('Generate a comprehensive report including both sales tax and CRV data for government compliance.')); ?></p>
                    
                    <form id="combinedReportForm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="combined_start_date"><?php echo e(__('Start Date')); ?></label>
                                    <input type="date" class="form-control" id="combined_start_date" name="start_date" value="<?php echo e(date('Y-m-01')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="combined_end_date"><?php echo e(__('End Date')); ?></label>
                                    <input type="date" class="form-control" id="combined_end_date" name="end_date" value="<?php echo e(date('Y-m-t')); ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-warning btn-lg text-dark">
                                <i class="fas fa-download me-2"></i>
                                <?php echo e(__('Download Combined Report (Excel)')); ?>
            ...
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h4 class="card-title mb-0">
                        ...
                        <?php echo e(__('Monthly Tax Summary')); ?>

                    </h4>
                </div>
                <div class="card-body">
                    <p class="text-muted"><?php echo e(__('Generate monthly tax summary for government filing purposes.')); ?></p>
                    
                    <form id="monthlyReportForm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="report_year"><?php echo e(__('Year')); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="report_month"><?php echo e(__('Month')); ?></label>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-info btn-lg" data-format="excel">
                                <i class="fas fa-download me-2"></i>
                                <?php echo e(__('Download Monthly Summary (Excel)')); ?>

                            </button>
                            <button type="submit" class="btn btn-outline-info" data-format="json">
                                <i class="fas fa-eye me-2"></i>
                                <?php echo e(__('View Monthly Summary')); ?>
            ...
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h4 class="card-title mb-0">
                        ...
                        <?php echo e(__('Compliance Information')); ?>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5><?php echo e(__('Sales Tax Compliance')); ?></h5>
                            <ul class="list-unstyled">
                                <li><i class="fas fa-check text-success me-2"></i><?php echo e(__('File monthly/quarterly returns')); ?></li>
                                <li><i class="fas fa-check text-success me-2"></i><?php echo e(__('Pay by 20th of following month')); ?></li>
                                <li><i class="fas fa-check text-success me-2"></i><?php echo e(__('Maintain records for 4 years')); ?></li>
                                <li><i class="fas fa-check text-success me-2"></i><?php echo e(__('Report all taxable sales')); ?></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <h5><?php echo e(__('CRV Compliance')); ?></h5>
                            <ul class="list-unstyled">
                                <li><i class="fas fa-recycle text-success me-2"></i><?php echo e(__('Monthly payments to CalRecycle')); ?></li>
                                <li><i class="fas fa-recycle text-success me-2"></i><?php echo e(__('Due by 15th of following month')); ?></li>
                                <li><i class="fas fa-recycle text-success me-2"></i><?php echo e(__('Track all beverage containers')); ?></li>
                                <li><i class="fas fa-recycle text-success me-2"></i><?php echo e(__('Maintain detailed records')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(__('Report Results')); ?></h5>
...
$(document).ready(function() {
    ...
    $('#taxReportForm').on('submit', function(e) {
        ...
        if (format === 'excel') {
            downloadReport('<?php echo e(route("admin.tax-crv.sales-tax")); ?>', formData, clickedButton);
        } else {
            viewReport('<?php echo e(route("admin.tax-crv.sales-tax")); ?>', formData, 'Sales Tax Summary', clickedButton);
        }
    });
    ...
    $('#crvReportForm').on('submit', function(e) {
        ...
        if (format === 'excel') {
            downloadReport('<?php echo e(route("admin.tax-crv.crv-report")); ?>', formData, clickedButton);
        } else {
            viewReport('<?php echo e(route("admin.tax-crv.crv-report")); ?>', formData, 'CRV Summary', clickedButton);
        }
    });
    ...
    downloadReport('<?php echo e(route("admin.tax-crv.combined")); ?>', formData, clickedButton);
});
    ...
    $('#monthlyReportForm').on('submit', function(e) {
        ...
        if (format === 'excel') {
            downloadReport('<?php echo e(route("admin.tax-crv.monthly-summary")); ?>', formData, clickedButton);
        } else {
            viewReport('<?php echo e(route("admin.tax-crv.monthly-summary")); ?>', formData, 'Monthly Tax Summary', clickedButton);
        }
    });
    ...
    function loadDashboardStats() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.tax-crv.dashboard-stats")); ?>',
            method: 'GET',
            success: function(data) {
